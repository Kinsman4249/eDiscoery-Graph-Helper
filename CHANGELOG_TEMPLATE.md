...
This file is a template for how entries in CHANGELOG.md should be written. It does not contain real entries. Copy the structure below and fill it in for each release.
...
```
### Short theme of the round (round two)
```
...
```
6. First change in this round goes here.
7. Second change in this round goes here.
8. Third change in this round goes here.
```
...
- Use a plain numbered list (`6.`, `7.`, `8.`), not nested bullets or sub-bullets within an item
- No tables
- No bold or italic text inside the entries themselves
