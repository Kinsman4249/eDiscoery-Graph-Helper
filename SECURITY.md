...
1. Go to the [Security tab](https://github.com/Kinsman4249/eDiscoery-Graph-Helper/security) of this repository.
...
- Vulnerabilities in the PowerShell script shipped by this project
- Insecure default configurations written by this project's setup code
- Any path that could allow privilege escalation or unauthorized access to credentials or mailbox data managed by this project

Out of scope:

- Vulnerabilities in the Microsoft Graph PowerShell SDK or Microsoft Purview itself - report those to Microsoft
- Vulnerabilities in other upstream dependencies - please report those to the dependency's own maintainers
- General hardening suggestions for your own tenant or environment (use a feature request issue instead)
